...
<div class="main-content">
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Price Escalation</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                                <li class="breadcrumb-item active">Add Price Escalation</li>
                            </ol>
                        </div>
            ...
            <form action="price-escalation-save.php" method="post" class="needs-validation"
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="card-header bg-primary bg-primary">
                                    <h5 class="text-white">Price Escalation Information</h5>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row gy-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" name="sros" id="sros"
                                                class="form-control" placeholder="Enter Star Rate Of Steel" required="">
                                        </div>
                                    </div>
