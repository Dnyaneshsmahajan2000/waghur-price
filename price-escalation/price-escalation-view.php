            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Add Price Escalation &nbsp; &nbsp; |&nbsp; &nbsp;
                            <a href="price-escalation-view.php">View All Price Escalation</a>
                        </h4>
                        <button type="button" onclick="location.href = 'price-escalation-add.php';"
                            ...
                            data-bs-target="#showModal"><i class="ri-add-line align-bottom me-1"></i> Add Prices
                            Escalation
                        </button>
                    </div>
                </div>
                        ...
                        <table class="table align-middle table-nowrap" id="customerTable">
                            <thead class="table">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="material">Material-(3)&nbsp;&nbsp;&nbsp;&nbsp;
                                    </th>
                                ...
                                <tr>
                                    ...
                                    foreach ($price_escalation as $value) {
                                        ...
                                        <td class="customer_name">
                                            ...
                                            <?php
                                            echo $monthYear = date("M-y", strtotime($value['month']));
                                            ?>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="remove">
                                                    <a
                                                        href="price-escalation-delete.php?pe_id=<?php echo $value['pe_id'] ?>">
