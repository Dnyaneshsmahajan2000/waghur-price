...
$totalAmountincomeQuery = "SELECT SUM(amount) AS total_amount
FROM transactions
WHERE is_deleted = 0
    AND user_id = $id
    AND (type = 'income' OR (type = 'transfer' AND amount > 0))
";
$totalAmountResult = $database->query($totalAmountincomeQuery)->fetch();
$totalIncome = $totalAmountResult['total_amount'];    

$totalAmountexpenseQuery = "
SELECT SUM(amount) AS total_amount
FROM transactions
WHERE is_deleted = 0
    AND user_id = $id
    AND (type = 'expense' OR (type = 'transfer' AND amount < 0));
";

$totalAmountResult = $database->query($totalAmountexpenseQuery)->fetch();
$totalExpense = $totalAmountResult['total_amount'];    
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                                    <div class="flex-grow-1">
                                        <h4 class="fs-16 mb-1"> <?php  echo   $message." ".$_SESSION['user']['name'];?></h4>
                                    </div>
